...
read_io: `:libso/readPID 2: (`readPidFile;2);

// Define the function that measures time and memory stats
mStats: {s_cpu:read_cycles[]; s_io:read_io[.z.i;`io]; op:`time`mem!system "ts 0N!", x; @[op;`cpudiff;:;read_cycles[]-s_cpu], read_io[.z.i;`io]-s_io};
